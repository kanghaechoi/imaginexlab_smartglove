        ...
        for mSubjectNum = 1 : 5
            if mIterationNum == 1 && mSubjectNum == 1
                [featuresMData, labelsMData] = ...
                    exp2FeatureExtractCell(B1, A1, ages, mIterationNum, genderID(1,1), mSubjectNum, gestureID(1,3)); ...
        ...
        for fSubjectNum = 1 : 3
            if fIterationNum == 1 && fSubjectNum == 1
                [featuresFData, labelsFData] = ...
                    exp2FeatureExtractCell(B1, A1, ages, fIterationNum, genderID(1,2), fSubjectNum, gestureID(1,3)); ...
                    %[features] = feature_extraction(b1, a1, age, file_count): Feature extraction
