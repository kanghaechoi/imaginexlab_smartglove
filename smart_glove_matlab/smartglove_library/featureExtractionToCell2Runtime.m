function [features, labels] = featureExtractionToCell2(B1, A1, AGE, fileCount, GENDER, subjectNum, gestureID,NumberFeatures)
%% Feature extraction
...
ageFeatures26 = [resizedWristAngleZ resizedHandAngleZ resizedThumbAccX resizedThumbVelX resizedIndexVelY ...
            resizedIndexAccX resizedIndexAngleX resizedIndexAccZ resizedWristVelZ resizedIndexVelZ ...
            resizedWristAccX resizedThumbVelZ resizedHandAngleX resizedThumbAccZ resizedIndexVelX];
...
features = ageFeaturesFull(:,1:NumberFeatures)';
...
labels = ones(1, 1);
%labels = (gestureID * labels);
labels = (AGE*10+GENDER*10+subjectNum);
end