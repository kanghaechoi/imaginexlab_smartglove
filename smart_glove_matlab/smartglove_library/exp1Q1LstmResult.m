function [featuresTotalCell, labelsTotalCell] = exp1Q1LstmResult(A1, B1, ages, fileCounts, genderID)
    ...
    for nM20 = 1 : fileCounts(:,1)
        if nM20 == 1
            [featuresM20Data, labelsM20Data] = ...
                exp1Q1FeatureExtractCell(B1, A1, ages(:,1), nM20, genderID(1,1)); ...
    ...
    for nF20 = 1 : fileCounts(:,2)
        if nF20 == 1
            [featuresF20Data, labelsF20Data] = ...
                exp1Q1FeatureExtractCell(B1, A1, ages(:,1), nF20, genderID(1,2)); ...
                %[features] = feature_extraction(b1, a1, age, file_count): Feature extraction
    ...
    for nM40 = 1 : fileCounts(:,3)
        if nM40 == 1
            [featuresM40Data, labelsM40Data] = ...
                exp1Q1FeatureExtractCell(B1, A1, ages(:,3), nM40, genderID(1,1)); ...
                %[features] = feature_extraction(b1, a1, age, file_count): Feature extraction
    ...
    for nF40 = 1 : fileCounts(:,4)
        if nF40 == 1
            [featuresF40Data, labelsF40Data] = ...
                exp1Q1FeatureExtractCell(B1, A1, ages(:,4), nF40, genderID(1,2)); ...
                %[features] = feature_extraction(b1, a1, age, file_count): Feature extraction
    ...
    for nM60 = 1 : fileCounts(:,5)
        if nM60 == 1
            [featuresM60Data, labelsM60Data] = ...
                exp1Q1FeatureExtractCell(B1, A1, ages(:,5), nM60, genderID(1,1)); ...
                %[features] = feature_extraction(b1, a1, age, file_count): Feature extraction
    ...
    for nF60 = 1 : fileCounts(:,6)
        if nF60 == 1
            [featuresF60Data, labelsF60Data] = ...
                exp1Q1FeatureExtractCell(B1, A1, ages(:,6), nF60, genderID(1,2)); ...
                %[features] = feature_extraction(b1, a1, age, file_count): Feature extraction
