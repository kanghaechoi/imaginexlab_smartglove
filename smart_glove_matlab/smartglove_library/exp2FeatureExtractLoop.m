...
smartphoneFeatures = [resizedWristAngleZ, resizedWristAccY, resizedThumbAngleX, ...
...
carkeyFeatures = [resizedWristAngleZ, resizedWristAngleX, resizedWristAccY, ...
...
features = carkeyFeatures(:, 1:numberOfFeatures)';
