...
if __name__ == '__main__':
    MODE = input('Select mode(\'svm\' or \'seq\'): ')

    if(MODE == 'svm'):
        ALL_FEATURE = './pickle_files/all_feature_svm.pickle'
        ALL_LABEL = './pickle_files/all_label_svm.pickle'
        ...
        ALL_FEATURE = './pickle_files/all_feature_seq.pickle'
        ALL_LABEL = './pickle_files/all_label_seq.pickle'
