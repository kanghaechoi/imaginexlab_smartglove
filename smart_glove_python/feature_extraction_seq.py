...
if __name__ == '__main__':
    ...
    FEATURE_PICKLE_PATH = './pickle_files/' + INSERTED_AGE + '_feature_seq.pickle'
    LABEL_PICKLE_PATH = './pickle_files/' + INSERTED_AGE + '_label_seq.pickle'
    ...
    print('Sequential features are extracted...')