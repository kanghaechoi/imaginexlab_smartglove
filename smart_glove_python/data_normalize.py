...
if __name__ == '__main__':
    FEATURE_20 = './pickle_files/20_feature_svm.pickle'
    FEATURE_50 = './pickle_files/50_feature_svm.pickle'
    FEATURE_70 = './pickle_files/70_feature_svm.pickle'

    LABEL_20 = './pickle_files/20_label_svm.pickle'
    LABEL_50 = './pickle_files/50_label_svm.pickle'
    LABEL_70 = './pickle_files/70_label_svm.pickle'

    FEATURE_ALL = './pickle_files/all_feature_svm.pickle'
    LABEL_ALL = './pickle_files/all_label_svm.pickle'
